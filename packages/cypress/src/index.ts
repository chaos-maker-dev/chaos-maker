...
export type {
  ...
  UserInteractionRetryStormConfig,
  UserInteractionTabHiddenConfig,
  UserInteractionBlurWindowConfig,
  UserInteractionPromptEditConfig,
  UserInteractionNavigateAwayConfig,
  ReplayFixture,
  ReplayChunk,
  ReplayMutation,
  StreamReplayConfig,
