...
export interface Scenario {
  ...
  title: string;
  /** Transport this scenario exercises. `ui` covers scenarios driven by
   *  user-interaction triggers rather than a network transport. */
  transport: 'network' | 'websocket' | 'sse' | 'fetch-stream' | 'ui';
  config: ChaosConfig;
  steps: Step[];
