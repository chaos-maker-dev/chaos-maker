...
- [Timeline and reporting concepts](/concepts/timeline-and-reporting/) — debug events feed `ruleHits` and `skipReasons` on the structured report
- [Reporting API reference](/api/reporting/)
